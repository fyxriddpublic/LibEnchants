...
import com.fyxridd.lib.enchants.EnchantsPlugin;
...
public class EnchantsApi {
    ...
    public static void reloadEnchants(String plugin) {
        EnchantsPlugin.instance.getEnchantsManager().reloadEnchants(plugin);
    }
    ...
    public static boolean addEnchant(String plugin, String type, ItemStack is) {
        return EnchantsPlugin.instance.getEnchantsManager().addEnchant(plugin, type, is);
    }
}
